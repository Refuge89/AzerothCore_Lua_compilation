...
if (player:GetLevel() >= 80) then
	if (player:GetClass() == 1) then -- warrior
		...
		elseif (player:GetClass() == 3) then -- hunter
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,3)
		elseif (player:GetClass() == 4) then -- rogue
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,4)
		elseif (player:GetClass() == 5) then -- priest
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,5)
		elseif (player:GetClass() == 6) then -- death knight
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,6)
		elseif (player:GetClass() == 7) then -- shaman
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,7)
		elseif (player:GetClass() == 8) then -- mage
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,8)
		elseif (player:GetClass() == 9) then -- warlock
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,9)
		elseif (player:GetClass() == 11) then -- druid
			player:GossipMenuAddItem(3,"[Costs 1000g] Learn me all my spells!",0,10)
	end
end
player:GossipMenuAddItem(3,"Reset Talent Points",0,11)
...
if (intid < 11 and intid > 0) then
	if (player:ModifyMoney(-10000000) == false) then
		intid = 0
...
if (intid == 11) then
        player:ResetTalents()
		player:SendBroadcastMessage("Your talent points have been reset.")
        player:GossipComplete()
end
